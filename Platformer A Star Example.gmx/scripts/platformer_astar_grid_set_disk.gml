//platformer_astar_grid_set_disk(grd,x,y,r,type,cost)
/*
**
**  grid = the cost grid being edited
**
**  x/y,r = the position and radius of the circle in which the terrain and cost are being set
**
...
ds_grid_set_disk(grd,argument1,argument2,argument3,argument4+median(0,999.999999,argument5))
